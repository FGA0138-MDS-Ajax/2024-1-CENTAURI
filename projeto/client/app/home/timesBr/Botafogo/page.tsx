...
export default function Home() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/v1/games/bota_fogo")
    ...
    return (
        ...
        <main className="flex flex-col items-center justify-center flex-grow">
            <img src="https://logodetimes.com/times/botafogo/logo-botafogo-2048.png" alt="Bota_Fogo" width={100} height={100} />
