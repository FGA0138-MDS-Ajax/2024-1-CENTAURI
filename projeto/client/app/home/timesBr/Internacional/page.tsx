...
export default function Home() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/v1/games/internacional")
    ...
    return (
        ...
        <main className="flex flex-col items-center justify-center flex-grow">
            <img src="https://logodetimes.com/times/internacional/logo-internacional-1536.png" alt="Internacioal" width={100} height={100} />
