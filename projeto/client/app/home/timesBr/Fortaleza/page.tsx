...
export default function Home() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/v1/games/fortaleza")
    ...
    return (
        ...
        <main className="flex flex-col items-center justify-center flex-grow">
            <img src="https://logodetimes.com/times/fortaleza/logo-fortaleza-1536.png" alt="Fortaleza" width={100} height={100} />
