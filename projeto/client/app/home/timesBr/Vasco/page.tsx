...
export default function Home() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/v1/games/vasco_da_gama")
    ...
    return (
        ...
        <main className="flex flex-col items-center justify-center flex-grow">
            <img src="https://logodetimes.com/times/vasco-da-gama/logo-vasco-da-gama-1536.png" alt="Vasco_Da_Gama" width={100} height={100} />
