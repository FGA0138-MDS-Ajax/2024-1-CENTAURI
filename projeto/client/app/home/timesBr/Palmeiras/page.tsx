...
export default function Home() {
    ...
    useEffect(() => {
        fetch("http://localhost:8000/api/v1/games/palmeiras")
    ...
    return (
        ...
        <main className="flex flex-col items-center justify-center flex-grow">
            <img src="https://logodetimes.com/times/palmeiras/logo-palmeiras-1536.png" alt="Palmeiras" width={100} height={100} />
